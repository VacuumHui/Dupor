...
export class MenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(width / 2, height * 0.3, 'DARK AGE', { fontSize: metrics.font(64), color: '#f2f2f2' }).setOrigin(0.5);

    const btn = this.add.rectangle(width / 2, height * 0.62, metrics.value(280), metrics.value(86), 0x2c1f46)
      .setStrokeStyle(2, 0x9b59b6)
      .setInteractive({ useHandCursor: true });
    this.add.text(btn.x, btn.y, 'NEW GAME', { fontSize: metrics.font(30), color: '#fff' }).setOrigin(0.5);
